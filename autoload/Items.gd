...
const DEFS := {
	"lesson_map": {
		"name": "Lesson Map",
		"short": "Map",
		"desc": "Preview the lesson shape and steady your next decision.",
	...
	"breathing_reset": {
		...
		"short": "Breathe",
		"desc": "Recover teacher composure before reacting.",
	...
	"student_profile_card": {
		...
		"short": "Profile",
		"desc": "Reveal one learner asset or need before choosing a move.",
	...
	"quiet_signal": {
		"name": "Quiet Signal",
		"short": "Signal",
		"desc": "Restore class order or attention with a least-intrusive cue.",
	...
	"noticing_lens": {
		"name": "Noticing Lens",
		"short": "Notice",
		"desc": "Surface the cue a novice teacher should attend to.",
	...
	"equity_snapshot": {
		...
		"short": "Equity",
		"desc": "Check who has not been heard from yet.",
	...
	"wait_meter_pin": {
		"name": "Wait Meter Pin",
		"short": "Wait",
		"desc": "Guarantee the next teacher move counts as deliberate wait time.",
	...
	"practice_goal_card": {
		...
		"short": "Goal",
		"desc": "Set a focused goal and earn extra XP if the scenario is cleared.",
